import type { Resume, ResumeCertification } from "lib/redux/types";
...
import { extractCertifications } from "lib/parse-resume-from-pdf/extract-resume-from-sections/extract-certifications";
