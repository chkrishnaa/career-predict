...
export const resumeSlice = createSlice({
  ...
  reducers: {
    ...
    changeCertifications: (
      draft,
      action: PayloadAction<CreateChangeActionWithDescriptions<ResumeCertification>>
    ) => {
      const { idx, field, value } = action.payload;
      const certification = draft.certifications[idx];
      certification[field] = value as any;
    },
